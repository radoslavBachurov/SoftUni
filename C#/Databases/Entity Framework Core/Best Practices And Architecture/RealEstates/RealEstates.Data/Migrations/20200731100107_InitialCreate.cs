        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RealEstateProperties_RealEstateTypes_RealEstateTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RealEstatePropertiesTags", x => new { x.TagId, x.RealEstatePropertyId });
                    table.ForeignKey(
                        name: "FK_RealEstatePropertiesTags_RealEstateProperties_RealEstatePropertyId",
                        column: x => x.RealEstatePropertyId,
                        principalTable: "RealEstateProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RealEstatePropertiesTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealEstateProperties_RealEstateTypeId",
                table: "RealEstateProperties",
                column: "RealEstateTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_RealEstatePropertiesTags_RealEstatePropertyId",
                table: "RealEstatePropertiesTags",
